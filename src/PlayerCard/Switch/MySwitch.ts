...
export const MySwitch = styled(Switch)(({theme}) => ({
    ...
    "& .MuiSwitch-switchBase": {
        ...
        "&.Mui-checked": {
            ...
            "& + .MuiSwitch-track": {
                opacity: 1,
                backgroundColor: theme.palette.mode === "light" ? "#D1D6F6" : "#182157",
            },
        },
    },
    "& .MuiSwitch-thumb": {
        ...
        "&:before": {
            content: theme.palette.mode === "light" ? "'Light'" : "'Dark'",
            color: theme.palette.mode === "light" ? "#FFFFFF" : "#7C83AF",
            paddingLeft: 28,
            position: "relative",
            fontSize: 14,
            left: 15,
            ...
            backgroundImage: `url('data:image/svg+xml;utf8,<svg width="18" height="18" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill="${encodeURIComponent(
                "#ffffff",
